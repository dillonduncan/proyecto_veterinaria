...
class Registro_Raza_Activity : AppCompatActivity(),RazasAdaptadorListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnAtras.setOnClickListener { startActivity(Intent(this@Registro_Raza_Activity,Registros_Principal_Activity::class.java)) }
    }
    fun ValidarGuardar(){
    ...
    fun LlenarSpinner(){
        lifecycleScope.launch {
            ...
            var adapter = object : ArrayAdapter<Tipos>(this@Registro_Raza_Activity,android.R.layout.simple_spinner_dropdown_item,listaTipos){
                override fun getItemId(position: Int): Long {
    ...
    fun ActualizarRaza(razas: Razas){
        lifecycleScope.launch {
            DB.ObtenerDB(this@Registro_Raza_Activity).RazaDao().ActualizarRaza(razas.nombre_raza,razas.tipo_Raza_id,razas.id_raza)
            ObtenerRaza()
            LimpiarCampos()
        }
    }
