...
class Registrarce_Usuario_Activity : AppCompatActivity() {
        ...
        binding.apply {
            btnRegistrarse.setOnClickListener{
                ...
                if (edtPassword.text.isNullOrEmpty()){
                    ...
                    Toast.makeText(this@Registrarce_Usuario_Activity, "Registro Exitoso", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
    fun AgregarUsuario(usuario:Usuario){
        lifecycleScope.launch {
            ...
            LimpiarCampos()
            idUser=DB.ObtenerDB(this@Registrarce_Usuario_Activity).RolesDao().ObtenerIdRolForName("Usuario")
        }
    }
